...
PLATFORM = 'Codeforces'
ACCENT = '#4f8df7'
DESCRIPTION = 'Competitive programming analytics for Codeforces handles, ratings, contests, solved tags, and activity heatmaps.'
PARAM = 'userid'
...
CANONICAL_ENDPOINTS = [
    ...
    ('GET', '/{userid}/stats', 'Solved counts and tags'),
    ('GET', '/{userid}/stats/svg', 'Embeddable stats SVG card (theme, exclude; 24h cache)'),
    ('GET', '/{userid}/topics', 'Solved tag analysis'),
    ('GET', '/{userid}/contests', 'Contest participation'),
    ('GET', '/{userid}/rating', 'Rating history'),
    ('GET', '/{userid}/heatmap', 'Submission heatmap'),
    ('GET', '/{userid}/badges', 'Empty badges'),
]
LEGACY_ENDPOINTS = [
    ('GET', '/{userid}/basic', 'Deprecated basic profile'),
    ('GET', '/{userid}/solved', 'Deprecated solved count'),
    ('GET', '/multi/{userids}', 'Multi-user info'),
    ('GET', '/users/common-contests/{userids}', 'Common contests'),
...
# ── Shared live playground (generic across every platform's response envelope) ──
